...
public class Alert: NSObject {
    class func presentDefaultAlert(delegate: UIViewController, message: String) {
        let defaultAlert = UIAlertController(title: "Alert", message: message, preferredStyle: UIAlertControllerStyle.alert)
    ...
    class func presentDefaultErrorMsg(delegate: UIViewController, message: String) {
        let defautErrorAlert = UIAlertController(title: "Error", message: message, preferredStyle: UIAlertControllerStyle.alert)
        defautErrorAlert.addAction(UIAlertAction(title: "OK", style: UIAlertActionStyle.default, handler: nil))
    ...
    class func presentLocationAlert(delegate: UIViewController, message: String) {
        let locationAlert = UIAlertController(title: "Location Accces Denied", message: message, preferredStyle: UIAlertControllerStyle.alert)
